            ...
            <TabsContent value="basics" className="space-y-4 pt-4">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  onChange={(e) => setBasics({ ...basics, subtitle: e.target.value })}
                />
              </div>
              <div className="grid gap-2">
            ...
            <TabsContent value="work" className="space-y-4 pt-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <Input
                    value={work.currentWork}
                    onChange={(e) => setWork({ ...work, currentWork: e.target.value })}
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    value={work.currentWorkLink}
                    onChange={(e) => setWork({ ...work, currentWorkLink: e.target.value })}
                    placeholder="https://..."
                  />
                </div>
              </div>
              <div className="grid gap-2">
                ...
                <Input
                  value={work.learning}
                  onChange={(e) => setWork({ ...work, learning: e.target.value })}
                  placeholder="Frameworks, languages..."
                />
              </div>
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  onChange={(e) => setWork({ ...work, portfolioLink: e.target.value })}
                  placeholder="https://..."
                />
              </div>
              <div className="grid gap-2">
                ...
                <Input
                  value={work.email}
                  onChange={(e) => setWork({ ...work, email: e.target.value })}
            ...
            <TabsContent value="skills" className="pt-4">
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {commonSkills.map((skill) => (
                  <div
                    key={skill}
                    className="flex items-center space-x-2 border p-2 rounded hover:bg-accent cursor-pointer"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="grid gap-2">
                  <Label className="flex items-center gap-2">
                    <Twitter className="w-4 h-4" /> Twitter Username
                  </Label>
                  <Input
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    value={socials.devto}
                    onChange={(e) => setSocials({ ...socials, devto: e.target.value })}
                    placeholder="username"
                  />
                </div>
              </div>
            ...
            <TabsContent value="addons" className="space-y-4 pt-4">
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    checked={addons.stats}
                    onCheckedChange={(v) => setAddons({ ...addons, stats: !!v })}
                    id="stats"
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    checked={addons.languages}
                    onCheckedChange={(v) => setAddons({ ...addons, languages: !!v })}
                    id="langs"
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    checked={addons.streak}
                    onCheckedChange={(v) => setAddons({ ...addons, streak: !!v })}
                    id="streak"
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    checked={addons.trophies}
                    onCheckedChange={(v) => setAddons({ ...addons, trophies: !!v })}
                    id="trophies"
                  />
        ...
        <div className="space-y-4">
          ...
          {previewMode === 'markdown' ? (
            <div className="p-4 bg-muted rounded-md border border-dashed border-foreground/30 overflow-auto max-h-[600px]">
              <pre className="whitespace-pre-wrap text-xs font-mono">{generateReadmeContent()}</pre>
            </div>
          ) : (
