 ...
 */
export type SafeJoinClause = '' | 'INNER JOIN user_skill_scores uss ON l.username = uss.username';
...
export function getSkillJoinClause(useSkillScoring: boolean): SafeJoinClause {
  return useSkillScoring ? 'INNER JOIN user_skill_scores uss ON l.username = uss.username' : '';
}
